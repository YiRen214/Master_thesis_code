...
Prim = R6::R6Class("Prim", inherit = RegDescMethod,
                   ...
                   public = list(
                     ...
                     #' @export
                     initialize = function(predictor, predictor_2,subbox_relsize = 0.05, strategy = "traindata", num_sampled_points = 500L, quiet = FALSE) {
                       # input checks
                       super$initialize(predictor, predictor_2,quiet)
                   ...
                   private = list(
                     ...
                     run = function(){
                       ...
                       if (is.null(private$obsdata)) {
                         private$obsdata = sampling(predictor = private$predictor, predictor_2 = private$predictor_2, x_interest = private$x_interest,
                       ...
                       private$obsdata = private$obsdata[, positive := predict_range(private$predictor,private$predictor_2, newdata = private$obsdata, range = private$desired_range)]
                       ...
                       if (is.null(private$box_largest)) {
                         private$box_largest = get_max_box(private$x_interest, private$fixed_features,
                                                           ...
                                                           predictor_2 = private$predictor_2,
