...
PostProcessing = R6::R6Class("PostProcessing", inherit = RegDescMethod,
                             public = list(
                               ...
                               initialize = function(predictor, predictor_2,subbox_relsize = 0.05,
                             ...
                             private = list(
                               ...
                               run = function(){
                                 ...
                                 homogeneous = sum(predict_range(private$predictor, private$predictor_2,newdata = sampled,
                               ...
                               evaluate_box = function(box, desired_range, x_interest) {
                                 ...
                                 evaluate_box(box, predictor = private$predictor, predictor_2 = private$predictor_2, x_interest = x_interest,
