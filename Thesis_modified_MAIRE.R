...
Maire = R6::R6Class("Maire", inherit = RegDescMethod,
                    public = list(
                      ...
                      initialize = function(predictor,predictor_2, num_of_iterations = 1000L, convergence = FALSE,
                    ...
                    private = list(
                      ...
                      run = function(){
                        ...
                        private$f_values_obsdata = data.table(predict_range(private$predictor,private$predictor_2,
